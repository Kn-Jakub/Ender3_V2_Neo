...
#define STRING_CONFIG_H_AUTHOR "Dzejkop Bejker" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -46, -6, 0 }  // MRiscoC BLTouch offset for support: https://www.thingiverse.com/thing:4605354 (z-offset = -1.80 mm)
...
#define X_MIN_POS -13  // MRiscoC Stock physical limit
#define Y_MIN_POS -7.5  // MRiscoC Stock physical limit
#define Z_MIN_POS 0
